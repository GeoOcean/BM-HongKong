...
tracks_per_year = 10                  # total number of tracks to simulate per year
...
lat_vort_fac = 0.5                    # sets where vorticity threshold decays toward equator # lat_vort_fac = 2 
