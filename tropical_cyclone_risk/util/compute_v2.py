...
def run_tracks(year, n_tracks, b):
    ...
    for i in range(12):
        _, num_days_month = calendar.monthrange(year, i+1)
        random_day = random.randint(1, num_days_month)
        dt_month = datetime.datetime(year, i + 1, random_day)
        ...
        # Guarda la fecha dt_month si seed_passed es True
        passed_dates.append(dt_month)
